...
from views import (get_all_animals, get_single_animal,
                   create_animal, delete_animal, update_animal, get_animals_by_location,
...
from views import (get_all_employees, get_single_employee,
                   create_employee, delete_employee, update_employee, get_employees_by_location)
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # If the path does not include a query parameter, continue with teh original if block
        if '?' not in self.path:
            (resource, id) = parsed
    ...
    def do_POST(self):
        ...
        # Add a new animal to the list.  Dont worry about the orange squiggle, you will define
        # the create_animal function next.
        if resource == "animals":
    ...
    def do_PUT(self):
        ...
        # Updates a single animal from the list
        if resource == "animals":
            success = update_animal(id, post_body)

        # 🦖🦖 commented out due to not currently being used.
        # if resource == "locations":
    ...
    def do_DELETE(self):
        ...
        # Encode the new animal and send in the response
        self.wfile.write("".encode())
